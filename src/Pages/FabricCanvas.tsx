    ...
    return (
        <div className='min-w-screen h-screen bg-black'>
            ...
            <div className='flex h-[calc(100%-60px)] w-screen'>
                ...
                <div className='h-full w-[calc(100%-675px)]'>
                    ...
                    <div className=' flex h-full'>
                        <div className={`flex justify-center relative items-center h-full ${!current_component ? 'w-[1200px]' : "w-[calc(100%-250px)] overflow-hidden"}`}>
                            <div className='w-[850px] m-h-[480px] flex justify-center items-center '>
